...
(function () {
  ...
  (Ticker._tick = function () {
    const a = Ticker.paused;
    const b = Ticker._getTime();
    const c = b - Ticker._lastTime;
    if (
      ((Ticker._lastTime = b),
      Ticker._ticks++,
      ...
      const d = new createjs.Event('tick');
      const e = Ticker.maxDelta;
      (d.delta = e && c > e ? e : c),
      (d.paused = a),
      (d.time = b),
...
(function () {
  ...
  const a = createjs.extend(AbstractTween, createjs.EventDispatcher);
  ...
  (a.setPosition = function (a, b, c, d) {
    ...
    if ((a < 0 && (a = 0), e === 0)) {
      ...
      const k = !this.reversed != !(this.bounce && h % 2);
      k && (i = e - i);
    }
    (this.position = i),
    (this.rawPosition = a),
  ...
  (a.calculatePosition = function (a) {
    ...
    let e = 0;
    if (b === 0) return 0;
    c !== -1 && a >= c * b + b ? ((e = b), (d = c)) : a < 0 ? (e = 0) : ((d = (a / b) | 0), (e = a - d * b));
    const f = !this.reversed != !(this.bounce && d % 2);
    return f ? b - e : e;
  }),
  (a.getLabels = function () {
    ...
    if (!a) {
      ...
      for (const c in b) a.push({ label: c, position: b[c] });
...
(function () {
  ...
  const c = createjs.extend(Tween, createjs.AbstractTween);
  (Tween.IGNORE = {}),
  (Tween._tweens = []),
  (Tween._plugins = null),
  ...
  (c.to = function (a, b, c) {
    (b == null || b < 0) && (b = 0);
    const d = this._addStep(+b, null, c);
  ...
  (c._addPlugin = function (a) {
    const b = this._pluginIds || (this._pluginIds = {});
    const c = a.ID;
    if (c && !b[c]) {
      b[c] = !0;
  ...
  (c._updateTargetProps = function (a, b, c) {
    if (!(this.passive = !!a.passive)) {
      ...
      let f;
      let g;
      const h = a.prev.props;
      const i = a.props;
      (g = a.ease) && (b = g(b, 0, 1, 1));
      const j = this._plugins;
      a: for (const k in h) {
        if (((e = h[k]), (f = i[k]), (d = e !== f && typeof e === 'number' ? e + (f - e) * b : b >= 1 ? f : e), j)) {
          for (let l = 0, m = j.length; m > l; l++) {
            const n = j[l].change(this, a, k, d, b, c);
  ...
  (c._runActionsRange = function (a, b, c, d) {
    const e = a > b;
    let f = e ? this._actionTail : this._actionHead;
    let g = b;
    let h = a;
    e && ((g = a), (h = b));
  ...
  (c._appendProps = function (a, b, c) {
    ...
    let g;
    let h;
    const i = this._stepHead.props;
    const j = this.target;
    let k = Tween._plugins;
    const l = b.prev;
    const m = l.props;
    const n = b.props || (b.props = this._cloneProps(m));
    const o = {};
    for (d in a) {
  ...
  (c._injectProp = function (a, b) {
    const c = this._injected || (this._injected = {});
    c[a] = b;
  }),
  (c._addStep = function (b, c, d, e) {
    const f = new a(this._stepTail, this.duration, b, c, d, e || !1);
    return (this.duration += b), (this._stepTail = this._stepTail.next = f);
  }),
  (c._addAction = function (a, c, d) {
    const e = new b(this._actionTail, this.duration, a, c, d);
...
(function () {
  ...
  const a = createjs.extend(Timeline, createjs.AbstractTween);
  ...
  (a._updatePosition = function (a) {
    for (let b = this.position, c = 0, d = this.tweens.length; d > c; c++) this.tweens[c].setPosition(b, !0, a);
  }),
...
(function () {
  ...
  (Ease.bounceInOut = function (a) {
    return a < 0.5 ? 0.5 * Ease.bounceIn(2 * a) : 0.5 * Ease.bounceOut(2 * a - 1) + 0.5;
  }),
...
(function () {
  ...
  (a.init = function (b, c) {
    c == 'guide' && b._addPlugin(a);
  }),
  (a.step = function (b, c, d) {
    for (const e in d) {
      if (e === 'guide') {
        const f = c.props.guide;
        const g = a._solveGuideData(d.guide, f);
        f.valid = !g;
        const h = f.endData;
        if ((b._injectProp('x', h.x), b._injectProp('y', h.y), g || !f.orient)) break;
        const i = void 0 === c.prev.props.rotation ? b.target.rotation || 0 : c.prev.props.rotation;
        if (((f.startOffsetRot = i - f.startData.rotation), f.orient == 'fixed')) (f.endAbsRot = h.rotation + f.startOffsetRot), (f.deltaRotation = 0);
        else {
          const j = void 0 === d.rotation ? b.target.rotation || 0 : d.rotation;
          const k = j - f.endData.rotation - f.startOffsetRot;
          const l = k % 360;
  ...
  (a.change = function (b, c, d, e, f) {
    const g = c.props.guide;
    if (g && c.props !== c.prev.props && g !== c.prev.props.guide) {
      return (d === 'guide' && !g.valid) || d == 'x' || d == 'y' || (d === 'rotation' && g.orient)
  ...
  (a._solveGuideData = function (b, c) {
    ...
    for (f = e[0], g = e[1], l = 2; o > l; l += 4) {
      ...
      const r = { weightings: [], estLength: 0, portion: 0 };
      let s = f;
      let t = g;
      for (m = 1; p >= m; m++) {
    ...
    n = c.totalLength;
    const w = c.subLines.length;
    for (l = 0; w > l; l++) c.subLines[l].portion = c.subLines[l].estLength / n;
    const x = isNaN(b.start) ? 0 : b.start;
    const y = isNaN(b.end) ? 1 : b.end;
  ...
  (a._ratioToPositionData = function (b, c, d) {
    ...
    let k = 0;
    const l = 10;
    const m = b * c.animSpan + c.startData.ratio;
    ...
    void 0 === i && ((i = f - 1), (k -= h));
    const n = j[i].weightings;
    const o = h;
    for (f = n.length, e = 0; f > e && ((h = n[e] * o), !(k + h >= m)); e++) k += h;
    (i = 4 * i + 2), (g = e / l + ((m - k) / h) * (1 / l));
    const p = c.path;
    return (
      a._getParamsForCurve(p[i - 2], p[i - 1], p[i], p[i + 1], p[i + 2], p[i + 3], g, c.orient, d),
      c.orient
            && (b >= 0.99999 && b <= 1.00001 && void 0 !== c.endAbsRot
  ...
  (a._findPathProblems = function (a) {
    ...
    if (c < 6 || (c - 2) % 4) {
      let d = "	Cannot parse 'path' array due to invalid number of entries in path. ";
      return (
