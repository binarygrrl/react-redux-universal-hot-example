...
(function () {
  ...
  const a = (BrowserDetect.agent = window.navigator.userAgent);
...
(this.createjs = this.createjs || {}),
(function () {
  const PlayPropsConfig = function () {
    (this.interrupt = null),
    (this.delay = null),
    (this.offset = null),
    (this.loop = null),
  ...
  const a = (PlayPropsConfig.prototype = {});
  const b = PlayPropsConfig;
  (b.create = function (a) {
    if (typeof a === 'string') {
      return (
        console
    ...
    if (a == null || a instanceof b || a instanceof Object) return new createjs.PlayPropsConfig().set(a);
    if (a == null) throw new Error('PlayProps configuration not recognized.');
  }),
  (a.set = function (a) {
    if (a != null) for (const b in a) this[b] = a[b];
    return this;
  }),
  (a.toString = function () {
...
(function () {
  ...
  (b._setMasterVolume = function (a) {
    ...
    ) for (let c = this._instances, d = 0, e = c.length; e > d; d++) c[d].setMasterVolume(a);
  }),
  (b.setVolume = createjs.deprecate(b._setMasterVolume, 'Sound.setVolume')),
  (b._masterMute = !1),
  (b._getMute = function () {
  ...
  (b._getCapabilities = function () {
    return b.activePlugin == null ? null : b.activePlugin._capabilities;
  }),
  (b.getCapabilities = createjs.deprecate(b._getCapabilities, 'Sound.getCapabilities')),
  Object.defineProperties(b, {
    volume: { get: b._getMasterVolume, set: b._setMasterVolume },
    muted: { get: b._getMute, set: b._setMute },
    capabilities: { get: b._getCapabilities }
  }),
  ...
  (b._handleLoadComplete = function (a) {
    const c = a.target.getItem().src;
    if (b._preloadHash[c]) {
      for (let d = 0, e = b._preloadHash[c].length; e > d; d++) {
        const f = b._preloadHash[c][d];
  ...
  (b.registerPlugins = function (a) {
    ...
    for (let c = 0, d = a.length; d > c; c++) if (b._registerPlugin(a[c])) return !0;
    return !1;
  }),
  (b.initializeDefaultPlugins = function () {
    return b.activePlugin != null
      ? !0
      : b._pluginsRegistered
        ? !1
        : b.registerPlugins([createjs.WebAudioPlugin, createjs.HTMLAudioPlugin])
          ? !0
          : !1;
  }),
  (b.isReady = function () {
  ...
  (b.initLoad = function (a) {
    return a.type == 'video' ? !0 : b._registerSound(a);
  }),
  (b._registerSound = function (c) {
    if (!b.initializeDefaultPlugins()) return !1;
    let d;
    if (
      (c.src instanceof Object ? ((d = b._parseSrc(c.src)), (d.src = c.path + d.src)) : (d = b._parsePath(c.src)),
      d == null)
    ) return !1;
    ...
    if (
      ...
      for (var g, h = e.audioSprite.length; h--;) {
        (g = e.audioSprite[h]),
        (b._idHash[g.id] = { src: c.src, startTime: parseInt(g.startTime), duration: parseInt(g.duration) }),
        g.defaultPlayProps
                && (b._defaultPlayPropsHash[g.id] = createjs.PlayPropsConfig.create(g.defaultPlayProps));
      }
    }
    c.id != null && (b._idHash[c.id] = { src: c.src });
    const i = b.activePlugin.register(c);
    return (
      a.create(c.src, f),
      e != null && isNaN(e) ? (c.data.channels = f || a.maxPerChannel()) : (c.data = f || a.maxPerChannel()),
  ...
  (b.registerSound = function (a, c, d, e, f) {
    let g = {
      src: a, id: c, data: d, defaultPlayProps: f
    };
    a instanceof Object && a.src && ((e = c), (g = a)),
    (g = createjs.LoadItem.create(g)),
    (g.path = e),
    e == null || g.src instanceof Object || (g.src = e + g.src);
    const h = b._registerSound(g);
    if (!h) return !1;
    if (
      (b._preloadHash[g.src] || (b._preloadHash[g.src] = []),
      b._preloadHash[g.src].push(g),
      b._preloadHash[g.src].length == 1)
    ) {
      h.on('complete', this._handleLoadComplete, this),
      h.on('error', this._handleLoadError, this),
      b.activePlugin.preload(h);
    } else if (b._preloadHash[g.src][0] == 1) return !0;
    return g;
  }),
  ...
  (b.removeSound = function (c, d) {
    if (b.activePlugin == null) return !1;
    c instanceof Object && c.src && (c = c.src);
    let e;
    if (
      (c instanceof Object ? (e = b._parseSrc(c)) : ((c = b._getSrcById(c).src), (e = b._parsePath(c))), e == null)
    ) return !1;
    (c = e.src), d != null && (c = d + c);
    for (const f in b._idHash) b._idHash[f].src == c && delete b._idHash[f];
  ...
  (b.loadComplete = function (a) {
    ...
    const c = b._parsePath(a);
    return (
      (a = c ? b._getSrcById(c.src).src : b._getSrcById(a).src),
      void 0 == b._preloadHash[a] ? !1 : b._preloadHash[a][0] == 1
    );
  }),
  (b._parsePath = function (a) {
    typeof a !== 'string' && (a = a.toString());
    const c = a.match(b.FILE_PATTERN);
    if (c == null) return !1;
  ...
  (b._parseSrc = function (a) {
    const c = { name: void 0, src: void 0, extension: void 0 };
    const d = b.capabilities;
    for (const e in a) {
    ...
    if (!c.src) return !1;
    const f = c.src.lastIndexOf('/');
    return (c.name = f != -1 ? c.src.slice(f + 1) : c.src), c;
  }),
  (b.play = function (a, c) {
    const d = createjs.PlayPropsConfig.create(c);
    const e = b.createInstance(a, d.startTime, d.duration);
    const f = b._playInstance(e, d);
  ...
  (b.createInstance = function (c, d, e) {
    ...
    let f = b._defaultPlayPropsHash[c];
    c = b._getSrcById(c);
    const g = b._parsePath(c.src);
    let h = null;
    return (
      g != null && g.src != null
        ? (a.create(g.src),
        d == null && (d = c.startTime),
        (h = b.activePlugin.create(g.src, d, e || c.duration)),
        (f = f || b._defaultPlayPropsHash[g.src]),
        f && h.applyPlayProps(f))
        : (h = new createjs.DefaultSoundInstance(c, d, e)),
  ...
  (b._playInstance = function (a, c) {
    const d = b._defaultPlayPropsHash[a.src] || {};
    if (
      (c.interrupt == null && (c.interrupt = d.interrupt || b.defaultInterruptBehavior),
      c.delay == null && (c.delay = d.delay || 0),
      c.offset == null && (c.offset = a.position),
      c.loop == null && (c.loop = a.loop),
      c.volume == null && (c.volume = a.volume),
      c.pan == null && (c.pan = a.pan),
      c.delay == 0)
    ) {
      const e = b._beginPlaying(a, c);
      if (!e) return !1;
    } else {
      const f = setTimeout(() => {
        b._beginPlaying(a, c);
  ...
  (b._beginPlaying = function (b, c) {
    ...
    const d = b._beginPlaying(c);
    if (!d) {
      const e = createjs.indexOf(this._instances, b);
  ...
  (b._playFinished = function (b) {
    a.remove(b);
    const c = createjs.indexOf(this._instances, b);
  ...
  (a.create = function (b, c) {
    const d = a.get(b);
    return d == null ? ((a.channels[b] = new a(b, c)), !0) : !1;
  }),
  (a.removeSrc = function (b) {
    const c = a.get(b);
    return c == null ? !1 : (c._removeAll(), delete a.channels[b], !0);
  }),
  (a.removeAll = function () {
    for (const b in a.channels) a.channels[b]._removeAll();
    a.channels = {};
  }),
  (a.add = function (b, c) {
    const d = a.get(b.src);
    return d == null ? !1 : d._add(b, c);
  }),
  (a.remove = function (b) {
    const c = a.get(b.src);
    return c == null ? !1 : (c._remove(b), !0);
  }),
  ...
  (c._getSlot = function (a) {
    let b; let
      c;
    if (a != Sound.INTERRUPT_NONE && ((c = this._get(0)), c == null)) return !0;
    for (let d = 0, e = this.max; e > d; d++) {
      if (((b = this._get(d)), b == null)) return !0;
      if (
        b.playState == Sound.PLAY_FINISHED
            || b.playState == Sound.PLAY_INTERRUPTED
            || b.playState == Sound.PLAY_FAILED
      ) {
        c = b;
        break;
      }
      a != Sound.INTERRUPT_NONE
            && ((a == Sound.INTERRUPT_EARLY && b.position < c.position)
              || (a == Sound.INTERRUPT_LATE && b.position > c.position))
            && (c = b);
    }
    return c != null ? (c._interrupt(), this._remove(c), !0) : !1;
  }),
  (c.toString = function () {
...
(this.createjs = this.createjs || {}),
(function () {
  const AbstractSoundInstance = function (a, b, c, d) {
    this.EventDispatcher_constructor(),
    (this.src = a),
    (this.uniqueId = -1),
    (this.playState = null),
  ...
  const a = createjs.extend(AbstractSoundInstance, createjs.EventDispatcher);
  (a.play = function (a) {
    const b = createjs.PlayPropsConfig.create(a);
  ...
  (a.applyPlayProps = function (a) {
    return (
      a.offset != null && this._setPosition(a.offset),
      a.loop != null && this._setLoop(a.loop),
      a.volume != null && this._setVolume(a.volume),
      a.pan != null && this._setPan(a.pan),
      a.startTime != null && (this._setStartTime(a.startTime), this._setDuration(a.duration)),
      this
    );
  }),
  (a.toString = function () {
  ...
  (a._setPlaybackResource = function (a) {
    return (
      ...
      this._duration == 0 && this._playbackResource && this._setDurationFromSource(),
      this
    );
  }),
  ...
  (a._beginPlaying = function (a) {
    return (
      ...
      this._setPan(a.pan),
      a.startTime != null && (this._setStartTime(a.startTime), this._setDuration(a.duration)),
      this._playbackResource != null && this._position < this._duration
        ? ((this._paused = !1),
...
(function () {
  ...
  const a = AbstractPlugin.prototype;
  ...
  (a.removeAllSounds = function () {
    for (const a in this._audioSources) this.removeSound(a);
  }),
...
(function () {
  ...
  const a = createjs.extend(WebAudioSoundInstance, createjs.AbstractSoundInstance);
  var b = WebAudioSoundInstance;
  (b.context = null),
  ...
  (a._handleSoundReady = function () {
    ...
    const a = 0.001 * this._duration;
    const c = Math.min(0.001 * Math.max(0, this._position), a);
    ...
    (this._soundCompleteTimeout = setTimeout(this._endedHandler, 1e3 * (a - c))),
  ...
  (a._createAndPlayAudioNode = function (a, c) {
    const d = b.context.createBufferSource();
    (d.buffer = this.playbackResource), d.connect(this.panNode);
    const e = 0.001 * this._duration;
    return (d.startTime = a + e), d.start(d.startTime, c + 0.001 * this._startTime, e - c), d;
  }),
  (a._pause = function () {
...
(function () {
  ...
  const a = createjs.extend(WebAudioPlugin, createjs.AbstractPlugin);
  var b = WebAudioPlugin;
  (b._capabilities = null),
  (b._panningModel = 'equalpower'),
  (b.context = null),
  (b._scratchBuffer = null),
  (b._unlocked = !1),
  (b.DEFAULT_SAMPLE_RATE = 44100),
  (b.isSupported = function () {
    const a = createjs.BrowserDetect.isIOS || createjs.BrowserDetect.isAndroid || createjs.BrowserDetect.isBlackberry;
    return location.protocol != 'file:' || a || this._isFileXHRSupported()
      ? (b._generateCapabilities(), b.context == null ? !1 : !0)
      : !1;
  }),
  (b.playEmptySound = function () {
    if (b.context != null) {
      const a = b.context.createBufferSource();
  ...
  (b._generateCapabilities = function () {
    if (b._capabilities == null) {
      ...
      if (b.context == null && ((b.context = b._createAudioContext()), b.context == null)) return null;
      b._scratchBuffer == null && (b._scratchBuffer = b.context.createBuffer(1, 1, 22050)),
      b._compatibilitySetUp(),
      'ontouchstart' in window
              && b.context.state != 'running'
              && (b._unlock(),
              document.addEventListener('mousedown', b._unlock, !0),
              document.addEventListener('touchstart', b._unlock, !0),
              document.addEventListener('touchend', b._unlock, !0)),
      (b._capabilities = { panning: !0, volume: !0, tracks: -1 });
      for (
        let c = createjs.Sound.SUPPORTED_EXTENSIONS, d = createjs.Sound.EXTENSION_MAP, e = 0, f = c.length;
        f > e;
        e++
      ) {
        const g = c[e];
        const h = d[g] || g;
        b._capabilities[g] = (a.canPlayType(`audio/${g}`) != 'no' && a.canPlayType(`audio/${g}`) != '')
  ...
  (b._createAudioContext = function () {
    ...
    if (/(iPhone|iPad)/i.test(navigator.userAgent) && c.sampleRate !== b.DEFAULT_SAMPLE_RATE) {
      const d = c.createBuffer(1, 1, b.DEFAULT_SAMPLE_RATE);
  ...
  (b._unlock = function () {
    b._unlocked
          || (b.playEmptySound(),
          b.context.state == 'running'
            && (document.removeEventListener('mousedown', b._unlock, !0),
            document.removeEventListener('touchend', b._unlock, !0),
            document.removeEventListener('touchstart', b._unlock, !0),
            (b._unlocked = !0)));
  }),
  (a.toString = function () {
  ...
  (a._addPropsToClasses = function () {
    ...
    (a._scratchBuffer = b._scratchBuffer),
...
(function () {
  ...
  (b.get = function (a) {
    ...
    return (
      c == null
        ? ((c = b._tags[a] = b._tagPool.get()), (c.src = a))
        : b._tagUsed[a]
          ? ((c = b._tagPool.get()), (c.src = a))
          : (b._tagUsed[a] = !0),
      c
    );
  }),
  ...
  (b.remove = function (a) {
    const c = b._tags[a];
    return c == null ? !1 : (b._tagPool.set(c), delete b._tags[a], delete b._tagUsed[a], !0);
  }),
  (b.getDuration = function (a) {
    const c = b._tags[a];
    return c != null && c.duration ? 1e3 * c.duration : 0;
  }),
  ...
  (c.get = function () {
    ...
    return (
      ...
      a.parentNode == null && document.body.appendChild(a),
      a
    );
  }),
  (c.set = function (a) {
    const b = createjs.indexOf(this._tags, a);
    b == -1 && ((this._tags.src = null), this._tags.push(a));
  }),
  (c.toString = function () {
    return '[TagPool]';
  }),
...
(function () {
  ...
  const a = createjs.extend(HTMLAudioSoundInstance, createjs.AbstractSoundInstance);
  ...
  (a._handleSoundReady = function () {
    if (this._playbackResource.readyState !== 4) {
      const a = this._playbackResource;
      return (
        a.addEventListener(createjs.HTMLAudioPlugin._AUDIO_READY, this._readyHandler, !1),
  ...
  (a._updateVolume = function () {
    if (this._playbackResource != null) {
      const a = this._muted || createjs.Sound._masterMute ? 0 : this._volume * createjs.Sound._masterVolume;
...
(function () {
  ...
  const a = createjs.extend(HTMLAudioPlugin, createjs.AbstractPlugin);
  var b = HTMLAudioPlugin;
  (b.MAX_INSTANCES = 30),
  ...
  (b._capabilities = null),
  (b.isSupported = function () {
    return b._generateCapabilities(), b._capabilities != null;
  }),
  (b._generateCapabilities = function () {
    if (b._capabilities == null) {
      const a = document.createElement('audio');
  ...
  (a.register = function (a) {
    ...
    const c = this.AbstractPlugin_register(a);
    return c.setTag(b), c;
  }),
  (a.removeSound = function (a) {
